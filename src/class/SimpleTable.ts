...
export default class SimpleTable extends Simple {
   ...
   *   optimization choices. Larger or smaller numbers do not mean better
   *   results or more work. Keep it and the input row order fixed when comparing
   *   repeated runs; changing it explores another layout.
