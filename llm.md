...
operation. Cosine calculations internally rescale extreme vector magnitudes
while preserving direction and source values. Non-finite computed distances also
