...
cases = []
for epsilon in [0.0, .01, .0001, .000001]:
...
print(json.dumps(encode(dict(
    ...
    packages=PACKAGES,
    settings=settings, fixedTraversalProbe=dict(condensedTree=tree_rows, referenceGlosh=outlier_scores(tree).tolist()), nonfiniteEncoding="Explicit strings, never bare nonstandard JSON NaN/Infinity", cases=cases,
