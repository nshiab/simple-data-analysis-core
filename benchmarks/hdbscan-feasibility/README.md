...
regenerated by `generate_reference.py` with Python hdbscan 0.8.44, NumPy 2.2.6,
...
duplicates, ties, different densities, and noise. The historical benchmark runs
used the original 0.8.40 reference; only the current correctness fixtures were
upgraded. See `test/data/hdbscan/README.md` for the fixed GLOSH traversal and
the separately documented finite-limit treatment of duplicate-heavy inputs.
